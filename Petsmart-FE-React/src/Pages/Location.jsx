...
const park_places = [
  { id: 1, name: "Arlington", value: "arlington" },
  { id: 2, name: "Houston", value: "houston" },
  { id: 3, name: "Dallas", value: "dallas" },
...
const ParksComponent = (props) => {
  ...
  const [location, setLocation] = useState(park_places[0].value);
  ...
  const [zoom, setZoom] = useState(outlets.length > 1 ? 11 : 15);
  ...
  const handleLocationChange = (event) => {
    ...
    const zm = filteredoutlets.length > 1 ? 11 : 15;
